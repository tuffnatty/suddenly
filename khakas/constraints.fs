...
\ встретилось две: истерге 'слушать' и систерге 'развязывать').
...
\ – сиспе 'не развязывай', систіп 'развязав'. В словарной базе
\ в поле ALTERNAT в качестве словоизменительной основы выписаны
\ вариант ис- и сис-. 
