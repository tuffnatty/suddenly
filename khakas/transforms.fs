...
\ 5. Выпадение конечной краткой гласной основы или аффикса
\ перед аффиксом -ох, -öк (производным от одноименной
\ усилительной частицы) [не всегда]: краткая неогубленная
\ гласная не первого слога, будь то гласная основы или аффикса,
\ предшествующая аффиксу -ох, -öк, выпадает: андох ‘там же’ <
\ анды ‘там’ + ох ‘же’.
\ С долгой гласной этого не происходит: мағаа ‘Dat от мин’ + ох
\ > мағааох. В первом слоге гласная любой длины не стягивается:
\ пу ‘этот’ + ох > пуох 'этот же'. 3pos в виде алломорфов -ы/-i
\ не стягивается: хызох < хыс+ох, но не < хыс-ы-ох. Показатель
...
:+ unfallout-confluence  ( -- )
  ...
  \ ‘замерз’. часка-лығ + ға - часкалыға ‘счастливому’.
  \stack-mark
...
:+ unfallout-vowelaffix  ( -- )
  ...
  \stack-mark
    ...
    \ но не < хыс-ы-ох. Показатель деепричастия на гласную не
    \ стягивается: Инейлерін тойға алаох килгеннер ‘жен своих на
    \ свадьбу взяв тоже, приехали’ (сказка Атығӌы Парачап).
    \ Диалектные показатели аллатива СА, САрЫ, делибератива
    \ ДАңАрЫ не стягиваются: айназох < айна-зы-ох
    \ ‘черт-3pos-Ass’,  *< айна-за-ох ‘черт-AllDial-Ass’. 
    \ Также не стягивается гласная дательного падежа при
    \ отсутствии фонетически выраженной согласной Г - т.е. после
    \ основ на Г, ң и гласные (кимееох, суғаох) и в посессивном
    \ склонении (адымаох, адынаох).
...
:+ unfallout-all  ( -- )
  ...
  \ 3.4. Выпадение конечных заднеязычных глухих в именных
  \ основах на -х, -к при сочетании с показателями
  \ принадлежности. Это происходит в многосложных (!) основах
  \ в интервокальной позиции и сопровождается последующим
